...
<div class="col md-12">
    ...
    <div class="card card-outline card-lightblue">
        <div class="card-header">
            <h3 class="card-title">Pendaftaran Diterima</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <table id="tb-diterima" class="table table-hover text-nowrap projects">
...
<script>
    $(function() {
        ...
        $("#tb-diterima").DataTable({
            "responsive": true,
            "lengthChange": false,
            "autoWidth": false,
            "buttons": ["copy", "csv", "excel", "pdf", "print"]
        }).buttons().container().appendTo('#tb-diterima_wrapper .col-md-6:eq(0)');
    });
</script>
