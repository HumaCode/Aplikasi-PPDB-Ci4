...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Jan 2022 pada 14.04
...
INSERT INTO `tbl_banner` (`id_banner`, `ket`, `banner`) VALUES
(1, 'Banner 1', 'ppdb1.jpg'),
(2, 'Banner 2', 'ppdb2.jpg'),
(3, 'Banner 3', 'ppdb3.jpg');
...
CREATE TABLE `tbl_jalur_masuk` (
  ...
  `jalur_masuk` varchar(125) DEFAULT NULL,
...
CREATE TABLE `tbl_jurusan` (
  ...
  `jurusan` varchar(125) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_lampiran` (
  ...
  `lampiran` varchar(125) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(2, 'Ijazah'),
(3, 'Scan KTP'),
(4, 'Transkrip Nilai (sudah di legalisir)');
...
CREATE TABLE `tbl_pendidikan` (
  ...
  `pendidikan` varchar(125) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_penghasilan` (
  ...
  `penghasilan` varchar(125) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(3, 'Rp. 500.000 - Rp. 1000.000'),
(5, 'Rp. 1000.000 s/d Rp. 3000.000');
...
CREATE TABLE `tbl_setting` (
  `id` int(11) NOT NULL,
  `nama_sekolah` varchar(125) DEFAULT NULL,
...
INSERT INTO `tbl_setting` (`id`, `nama_sekolah`, `alamat`, `kecamatan`, `kabupaten`, `provinsi`, `no_telepon`, `email`, `web`, `deskripsi`, `logo`, `beranda`) VALUES
(1, 'Sekolah Update', 'Jl. Diponegoro', 'Kajen', 'Pekalongan', 'Jawa Tengah', '090909012822', 'example@gmail.com', 'http://www.sekolah.com', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur culpa odit aperiam eos modi quo nihil. Ipsa, illo quae dicta natus ab nemo! Quam, iure? Eum veniam quas incidunt asperiores! ', '1641989660_e9f98c83288dce73d486.png', '<h2 style=\"text-align: center; margin-right: 0px; margin-bottom: 0.5em; margin-left: 0px; line-height: normal;\"><b><font color=\"#085294\">LAYANAN SIAP PPDB Online</font></b></h2><p class=\"hidden-xs \" style=\"text-align: justify; margin-right: 0px; margin-bottom: 10px; margin-left: 0px;\">Layanan SIAP PPDB Online adalah sebuah Sistem Layanan yang dirancang untuk memfasilitasi otomasi pelaksanaan Penerimaan Peserta Didik Baru (PPDB), dari proses pendaftaran, seleksi hingga pengumuman hasil seleksi berbasis waktu nyata melalui Internet.</p><p class=\"hidden-xs \" style=\"text-align: justify; margin-right: 0px; margin-bottom: 10px; margin-left: 0px;\">Layanan ini disediakan menggunakan&nbsp;<font color=\"#444444\" face=\"Roboto, sans-serif\"><span style=\"font-size: 18.2px; background-color: rgb(244, 244, 244);\">Teknologi Web dan Cloud Computing</span></font>&nbsp;(Komputasi Awan) yang dapat membantu sekolah dalam melaksanakan Layanan PPDB dengan lebih mudah, cepat, transparan, akurat dan akuntabel secara Online di Internet.</p><p class=\"hidden-xs \" style=\"text-align: justify; margin-right: 0px; margin-bottom: 10px; margin-left: 0px;\"><br></p><p class=\"hidden-xs \" style=\"text-align: justify; margin-right: 0px; margin-bottom: 10px; margin-left: 0px;\"><br></p><h1 class=\"title-promo\" style=\"margin-right: 0px; margin-bottom: 0.5em; margin-left: 0px; line-height: normal;\"><b>Manfaat dan Keuntungan</b></h1><p style=\"box-sizing: border-box; font-family: inherit; line-height: normal; color: inherit; margin: 0px 0px 1em; font-size: 1.3em; padding: 0px;\"><b>Bagi Dinas Pendidikan dan Sekola</b></p><p style=\"box-sizing: border-box; line-height: normal; margin: 0px 0px 1em; padding: 0px;\"></p><p style=\"box-sizing: border-box; line-height: normal; margin: 0px 0px 1em; padding: 0px;\"></p><ul style=\"margin-top: 20px; padding-left: 15px; margin-bottom: 10px !important;\"><ul></ul></ul><p></p><ul><li style=\"text-align: justify;\">Efisiensi pembiayaan dan mengurangi resiko terjadinya KKN (Korupsi, Kolusi dan Nepotisme).</li><li style=\"text-align: justify;\">Meningkatkan reputasi sekolah.</li><li style=\"text-align: justify;\">Memberikan akses yang luas kepada masyarakat.</li><li style=\"text-align: justify;\">Tersedianya sebuah basis data terintegrasi bagi pihak Dinas Pendidikan maupun Sekolah dalam penyelenggaran penerimaan peserta didik baru.</li></ul><h3 class=\"sub-title-promo\" style=\"box-sizing: border-box; font-family: inherit; line-height: normal; color: inherit; margin: 0px 0px 1em; font-size: 1.3em; padding: 0px;\"><b>Bagi Siswa dan Orang Tua Siswa</b></h3><p></p><ul><li style=\"box-sizing: border-box; font-family: inherit; font-weight: 500; line-height: normal; color: inherit; margin: 0px 0px 1em; font-size: 1.3em; padding: 0px;\">Mempermudah untuk melakukan pendafaran siswa baru.</li></ul><ul><li style=\"box-sizing: border-box; font-family: inherit; font-weight: 500; line-height: normal; color: inherit; margin: 0px 0px 1em; font-size: 1.3em; padding: 0px;\">Mempermudah akses informasi penerimaan siswa baru.</li></ul><ul><li style=\"box-sizing: border-box; font-family: inherit; font-weight: 500; line-height: normal; color: inherit; margin: 0px 0px 1em; font-size: 1.3em; padding: 0px;\">Pendaftaran menjadi lebih tertib dan mudah dipantau.</li></ul><ul><li style=\"box-sizing: border-box; font-family: inherit; font-weight: 500; line-height: normal; color: inherit; margin: 0px 0px 1em; font-size: 1.3em; padding: 0px;\">Fasilitas dan pelayanan memuaskan dari pihak Sekolah dan Dinas Pendidikan.</li></ul>');
...
CREATE TABLE `tbl_siswa` (
  ...
  `no_pendaftaran` varchar(13) DEFAULT NULL,
  `tgl_pendaftaran` date DEFAULT NULL,
  `ta` year(4) DEFAULT NULL,
  ...
  `saudara_angkat` varchar(50) DEFAULT NULL,
  `saudara_tiri` varchar(50) DEFAULT NULL,
  ...
  `alamat_ayah` varchar(125) DEFAULT NULL,
  ...
  `tempat_lahir_ibu` varchar(125) DEFAULT NULL,
  `tgl_lahir_ibu` date DEFAULT NULL,
  `alamat_ibu` varchar(125) DEFAULT NULL,
  ...
  `tempat_lahir_wali` varchar(125) DEFAULT NULL,
  `tgl_lahir_wali` date DEFAULT NULL,
  `alamat_wali` varchar(125) DEFAULT NULL,
  ...
  `golongan_darah` varchar(125) DEFAULT NULL,
  `penyakit` varchar(125) DEFAULT NULL,
  `kelainan_lain` varchar(125) DEFAULT NULL,
  `asal_sekolah` varchar(100) DEFAULT NULL,
  `th_lulus` int(11) DEFAULT NULL,
  `no_ijazah` varchar(125) DEFAULT NULL,
  `no_skhun` varchar(125) DEFAULT NULL,
  `stat_pendaftaran` int(1) DEFAULT 0,
  `stat_ppdb` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_th_ajar`
--

CREATE TABLE `tbl_th_ajar` (
  `id_th_ajar` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `tbl_th_ajar`
--

INSERT INTO `tbl_th_ajar` (`id_th_ajar`, `tahun`, `ta`, `status`) VALUES
(1, 2020, '2020/2021', 0),
(2, 2021, '2021/2022', 0),
(3, 2022, '2022/2023', 1);
...
(1, 'Admin', 'admin@gmail.com', '$2y$10$dcYAadtmeTBQKQ8rYrCaFesqU1JX1yPQozxyVCw4VaQQQ5eiZrlkK', 'default.png'),
(9, 'tono', 'tono@gmail.com', '$2y$10$ulp8aJghecfKMRYhypS3He52MSwfKDprsBFwLa2T.957ybTkPfJ2i', '1641969674_f5d0d6fd0b424fe8647e.png');
...
--
-- Indeks untuk tabel `tbl_th_ajar`
--
ALTER TABLE `tbl_th_ajar`
  ADD PRIMARY KEY (`id_th_ajar`);
...
--
ALTER TABLE `tbl_jalur_masuk`
  MODIFY `id_jalur_masuk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT untuk tabel `tbl_th_ajar`
--
ALTER TABLE `tbl_th_ajar`
  MODIFY `id_th_ajar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
